        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              ...
              <div class="add">
                <!--这里的路由跳转，要在路由跳转之前，发请求把购买的产品的信息通过请求的形式通知服务器，服务器进行相应的存储-->
...
<script>
  ...
  export default {
    ...
    methods:{
      ...
      async addShopcar(){
        //派发action
        //发请求将购买所选择大的产品数据发给服务器先存起来，然后到购物车页面再展示
        //请求成功
        //这里本来应该是skuId:this.$route.params.skuid,但是这个id没有数据，所以先强制为1
        //使用try，catch来对于成功失败进行反应
        try{
        ...
        //这里加上await是为了等待action中返回的promise
        //判断是否失败，请求失败
        catch(error){
            alert(error.message)
        }
